"""Test the Microsoft Graph Calendar config flow."""
from homeassistant import config_entries, setup
from homeassistant.components.microsoft_graph_calendar.const import (
    DOMAIN,
    OAUTH2_AUTHORIZE,
    OAUTH2_TOKEN,
)
...
async def test_full_flow(hass, aiohttp_client, aioclient_mock):
    ...
    result = await hass.config_entries.flow.async_init(
        "microsoft_graph_calendar", context={"source": config_entries.SOURCE_USER}
    )
